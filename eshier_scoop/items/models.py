...
class Items(Model, model.Model, model.TimeMixin):
    ...
    used_stock = fields.IntField()
    total_restock = fields.IntField()
    single_price = fields.DecimalField(max_digits=50, decimal_places=2)
